        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="glass p-8 border-white/5 flex justify-between px-12">
              ...
              <motion.a whileHover={{ y: -5, color: '#ec4899' }} href="https://www.instagram.com/j0elllllll?igsh=MXIwYTYxbXl2YmZlbw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-white/40"><FaInstagram size={28} /></motion.a>
            </div>
          </div>
